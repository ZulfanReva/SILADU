        ...
        if ($_GET['hal'] == "edit") {
            ...
            if ($edit) {
                echo "<script>
                    ...
                    window.location.href = 'hasil_pengaduan_alat_pangan.php';
                </script>";
            } else {
                echo "<script>alert('Edit Data Gagal!'); history.back();</script>";
            }
        } else {
            $sql = "INSERT INTO pengaduan_alat_ketahananpangan ( jenis_alat, waktu_kerusakan, penyebab_kerusakan, permintaan, path_gambar, tgl_selesai, catatan_admin, keterangan_petugas, tgl_pengaduan)
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, NOW())";
    ...
    if ($_GET['hal'] == "hapus") {
        ...
        if ($hapus) {
            echo "<script>
                    ...
                    location='hasil_pengaduan_alat_pangan.php';
                  </script>";
        }
                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-9">
                                <input type="date" class="form-control" name="tgl_selesai"><?= $tgl_selesai; ?>
                            </div>
                        </div>
                        <div class="mb-3 row">
