        ...
        if (isset($_GET['hal']) && $_GET['hal'] == "edit") {
            ...
            if ($edit) {
                echo "<script>
                    ...
                    window.location.href = 'pengaduan_alat_pertanian.php';
                </script>";
            } else {
            ...
            $id_user = $row['id_user'];
            $sql = "INSERT INTO pengaduan_alat_pertanian (id_user, jenis_alat, waktu_kerusakan, penyebab_kerusakan, permintaan, path_gambar, tgl_pengaduan)
                    VALUES (?, ?, ?, ?, ?, ?, NOW())";
...
<body>
    ...
    <div class="container-fluid administrasi">
        ...
        <div class="card-wrap mt-4">
            <h3 class="card-title text-center">Daftar Pengaduan Alat Pertanian</h3>
            <div class="card-body">
                <table class="table table-bordered table-striped">
                    ...
                    if ($_SESSION['level'] == "petugas" || $_SESSION['level'] == "admin") {
                        $query = "SELECT * FROM pengaduan_alat_pertanian";
                    } elseif ($_SESSION['level'] == "warga") {
                        $query = "SELECT * FROM pengaduan_alat_pertanian WHERE nama_pemohon='$nama'";
                    }
                    ...
                    while ($row = mysqli_fetch_array($result)) :
                        $imagePath = "../petugas/uploads/pengaduan_alat_pertanian/" . $row['path_gambar'];
                    ...
                    ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="pengaduan_alat_pertanian.php?hal=edit&id=<?php echo $row['id_pengaduan'] ?>" class="btn btn-warning"><i class="fa-solid fa-pen-to-square"></i></a>
                                <a href="pengaduan_alat_pertanian.php?hal=hapus&id=<?php echo $row['id_pengaduan'] ?>" onclick="return confirm('Apakah yakin ingin menghapus data ini?')" class="btn btn-danger"><i class="fa-solid fa-trash"></i></a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                </table>
