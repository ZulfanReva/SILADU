...
// Ambil data permohonan uji tanaman milik user (hanya satu karena id_user UNIQUE)
$sql_permohonan = "SELECT id_permohonan, jenis_tanaman, alamat_pemohon, tgl_permohonan, status, catatan 
...
$jenis_tanaman = $permohonan['jenis_tanaman'] ?? '';
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Validasi
    if (empty($jenis_tanaman)) $errors[] = 'Jenis tanaman wajib diisi.';
    if (empty($alamat_pemohon)) $errors[] = 'Alamat pemohon wajib diisi.';
    ...
    if (count($errors) === 0) {
        if ($permohonan) {
            ...
            $stmt = $conn->prepare("UPDATE permohonan_uji_tanaman 
                SET jenis_tanaman = ?, alamat_pemohon = ?, tgl_permohonan = ?, status = 'Diproses', catatan = NULL 
                WHERE id_user = ?");
            $stmt->bind_param("sssi", $jenis_tanaman, $alamat_pemohon, $tgl_permohonan, $id_user);
        } else {
            // Belum ada, insert baru
            $stmt = $conn->prepare("INSERT INTO permohonan_uji_tanaman 
                (id_user, jenis_tanaman, alamat_pemohon, tgl_permohonan, status) 
                VALUES (?, ?, ?, ?, 'Diproses')");
            $stmt->bind_param("isss", $id_user, $jenis_tanaman, $alamat_pemohon, $tgl_permohonan);
        }
...
<body class="g-sidenav-show  bg-gray-100">
                ...
                <div class="col-12">
                    <div class="card mb-4">
                        <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                            <h6 class="mb-0">Tabel Uji Tanaman</h6>
                            ...
                            <div class="table-responsive p-0">
                                <table class="table align-items-center mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" style="padding: 9px;">Jenis<br>Tanaman</th>
                                            <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7" style="padding: 9px;">Alamat<br>Pemohon</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr data-id="2">
                                            ...
                                            <td class="text-center" style="padding: 9px;">
                                                <p class="text-xs font-weight-bold mb-0">Jagung</p>
                                            </td>
                                            <td class="text-center" style="padding: 9px;">
                                                <p class="text-xs font-weight-bold mb-0">Desa Harapan No.2</p>
                                            </td>
                                            <td class="text-center" style="padding: 9px;">
                                ...
                                <script>
                                    ...
                                    function handlePetugasChange(selectEl) {
                                        ...
                                        // Simpan status sementara (opsional: Ajax call untuk update DB)
                                    }
                                    ...
                                    function handleKadisChange(selectEl) {
                                        ...
                                        // Simpan status final (opsional: Ajax call untuk update DB)
                                    }
                                    ...
                                    function handleEdit(button) {
                                        ...
                                        document.getElementById('edit_alamat_pemohon').value = alamat;
    ...
    <!-- Modal Tambah Data - Permohonan Uji Tanaman -->
    <div class="modal fade" id="tambahDataModal" tabindex="-1" aria-labelledby="tambahDataModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="tambahDataModalLabel">Tambah Permohonan Uji Tanaman</h5>
                ...
                <form id="formTambahData">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="alamat_pemohon" class="form-control" required>
                        </div>
                        <div class="mb-3">
    ...
    <!-- Modal Edit Data - Permohonan Uji Tanaman -->
    <div class="modal fade" id="editDataModal" tabindex="-1" aria-labelledby="editDataModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editDataModalLabel">Edit Permohonan Uji Tanaman</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="formEditData">
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label class="form-label">Alamat Pemohon</label>
                            <input type="text" name="alamat_pemohon" class="form-control" id="edit_alamat_pemohon" required>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Tanggal Permohonan</label>
    ...
    <!-- Modal Delete Confirmation - Permohonan Uji Tanaman -->
