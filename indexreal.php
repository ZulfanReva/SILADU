	...
	<table width=90% height=90%>
			<tr>
				<td bgcolor=#9edcf9><br>
					<h1 align=center>Sistem Informasi Pelayanan Terpadu untuk Perizinan Permohonan Bantuan dan Pengaduan Masyarakat</h1>
				</td>
			</tr>
			<tr>
				<td bgcolor="#e1edf4">
					<marquee behavior="alternate">Selamat Datang di SILADUMA</marquee>
				</td>
			</tr>
			<tr>
				<td bgcolor=#fff><br>
